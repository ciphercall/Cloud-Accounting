    ...
    public class CostPoolReportController : AppController
    {
        ...
        public ActionResult CostPoolSingle(PageModel model)
        {
            ...
            if (model.FromDate > model.ToDate)
            {
                ...
                return RedirectToAction("CostPoolSingle");
            }
        ...
        public ActionResult CostPoolTranSummary(PageModel model)
        {
            ...
            if (model.FromDate > model.ToDate)
            {
                TempData["ErrorFromDateMessage"] = "Plese select correct 'From Date' field!";
                TempData["ErrorToDateMessage"] = "Plese select correct 'To Date' field!";
                return RedirectToAction("CostPoolTranSummary");
            }
        ...
        public ActionResult CostPoolTranDetails(PageModel model)
        {
            ...
            if (model.FromDate > model.ToDate)
            {
                TempData["ErrorFromDateMessage"] = "Plese select correct 'From Date' field!";
                TempData["ErrorToDateMessage"] = "Plese select correct 'To Date' field!";
                return RedirectToAction("CostPoolTranDetails");
            }
        ...
        public ActionResult CostPoolHead(PageModel model)
        {
            ...
            if (model.FromDate > model.ToDate)
            {
                TempData["ErrorFromDateMessage"] = "Plese select correct 'From Date' field!";
                TempData["ErrorToDateMessage"] = "Plese select correct 'To Date' field!";
                return RedirectToAction("CostPoolHead");
            }
